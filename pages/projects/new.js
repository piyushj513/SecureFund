...
class newProject extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      var projectName = CryptoJS.AES.encrypt(JSON.stringify(this.state.projectName), 'my-secret-key@123').toString();
      var description = CryptoJS.AES.encrypt(JSON.stringify(this.state.description), 'my-secret-key@123').toString();
      var imageUrl = CryptoJS.AES.encrypt(JSON.stringify(this.state.imageUrl), 'my-secret-key@123').toString();
