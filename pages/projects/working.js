        ...
        return(
            ...
            <h3 className="working open-campaigns">How SecureFund Works</h3>
              <Grid.Row>
                ...
                <div className="working-item">
                    <img
                      className="working-image" src={viewImg.src}></img>
                    <div>
                    <Header as='h4' color='blue'>View Active Projects</Header>
                      <p >
                        All the active projects and their details can be viewed
                        such as payments made from the contract to others.
                      </p>
                    </div>
                  </div>
                </Grid.Column>
              ...
              <Grid.Row>
                ...
                <div className="working-item">
                    <img
                      className="working-image" src={reqImg.src}></img>
                    <div>
                    <Header as='h4' color='blue'>Fund Project</Header>
                      <p>
                        Fund the active projects using crypto wallets.
                      </p>
                    </div>
                  </div>
                </Grid.Column>
                ...
                <div className="working-item">
                    ...
                    <Header as='h4' color='blue'>Transfer Funds</Header>
                      <p>
                        Transfer the money collected to other
